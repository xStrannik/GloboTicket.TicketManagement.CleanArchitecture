...
namespace GloboTicket.TicketManagement.Persistence
{
    public class GloboTicketDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var concertGuid = Guid.Parse("{8F58BB5A-F091-4465-81B4-01F45BDE17A2}");
            var musicalGuid = Guid.Parse("{0BBAC996-F18E-420E-96A1-7BEE3DC3C3B7}");
            var playGuid = Guid.Parse("{6B305EE4-30B3-42E8-A900-6527BC9C4402}");
            var conferenceGuid = Guid.Parse("{3E4263BB-03D7-4325-9A2A-F5D9CCFD5162}");
